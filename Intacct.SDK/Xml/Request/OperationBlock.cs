    ...
    public class OperationBlock : IXmlObject
    {
        ...
        public OperationBlock(ClientConfig clientConfig, RequestConfig requestConfig, List<IFunction> content)
        {
            ...
            else if (credentials != null && credentials.GetType() == typeof(LoginCredentials))
            {
                ...
                this.Authentication = new LoginAuthentication(loginCreds.UserId, loginCreds.CompanyId, loginCreds.Password, loginCreds.LocationId);
            }
            ...
            {
                Authentication = new LoginAuthentication(clientConfig.UserId, clientConfig.CompanyId, clientConfig.UserPassword, clientConfig.LocationId);
            }
            else
            {
